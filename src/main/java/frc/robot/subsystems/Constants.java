...
public class Constants {
    ...
    // makes variable that holds all apriltag positions on the field
        ...
        public static final Matrix<N3, N1> kSingleTagStdDevs = VecBuilder.fill(1.3, 1.3, 2);
        public static final Matrix<N3, N1> kMultiTagStdDevs = VecBuilder.fill(0.9, 0.9, 1);
